                    ...
                    <div className="main-content main-content-table overflow-auto">
                        <table className="table table-borderless">
                            ...
                            <tbody id="list_status_item">
                                <TableRow image={"overview-1"} title={'Mobile Legends'} category={'Mobile'} item={200} price={290000} status={"Pending"}/>
                                ...
                                <TableRow image={"overview-4"} title={'The Royale Game'} category={'Dekstop'} item={225} price={200000} status={"Pending"}/>
                            </tbody>
                        </table>
                    </div>
                </div>
